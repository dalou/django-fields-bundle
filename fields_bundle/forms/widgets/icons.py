...
class IconWidget(forms.widgets.TextInput):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #     del kwargs['currency']
        super(IconWidget, self).__init__(*args, **kwargs)
    ...
    def render(self, name, value, attrs=None):
        ...
        for title, local_path, path, classname, prefix in self.styles:
            ...
            for item in re.finditer(
                ...
                contents += """<a class="admin-icon-widget %s" data-value="%s"><i class="%s"></i></a>""" % (
        ...
        html += """</div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $(document).on('click', '#icons-%(id)s .admin-icon-widget', function() {
                         $('.admin-icon-widget.active').removeClass('active')
        ...
        """ % {
            'inherit' : super(IconWidget, self).render(name, value, attrs=attrs),
            'id': id
        }
